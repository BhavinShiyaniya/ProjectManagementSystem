...
function navbarColorOnResize() {
    sidenav && (1200 < window.innerWidth ? referenceButtons.classList.contains("active") && "bg-default" === referenceButtons.getAttribute("data-class") ? sidenav.classList.remove("bg-white") : body.classList.contains("dark-version") || sidenav.classList.add("bg-white") : (sidenav.classList.add("bg-white"),
...
function darkMode(e) {
    ...
    if (e.getAttribute("checked")) {
        ...
        x.includes("logo-ct.png") && (q = x.replace("logo-ct", "logo-ct-dark"),
        w.src = q);
        ...
        x.includes("logo-ct-dark.png") && (q = x.replace("logo-ct-dark", "logo-ct"),
        w.src = q);
